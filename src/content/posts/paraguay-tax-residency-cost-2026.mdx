...
Worth saying out loud: the price gap between tiers is small relative to what they unlock. The jump from Core to Premium is $1,000, and what you get for that thousand is your tax residency certificate, your tax number, and a year of accounting hand-holding. Skipping those to save $1,000 is a false economy — without a TRC, your old country's tax authority has no clean evidence that you've moved your tax base. That's the bit that actually defends you.
...
- **Apostilled documents** — €100-200 depending on country. Birth certificate and (if applicable) marriage certificate.
...
The full mechanics of why this works (territorial tax, OECD compatibility, exit from your old residency) are in the [complete Paraguay setup guide](/posts/paraguay-tax-residency-guide).
...
If you want a personalised read on which tier fits your situation, [book a free 20-minute clarity call](https://cal.com/nomadtaxhelp/clarity-call) and I'll walk you through it. If you want to gauge your current tax exposure first, the [Tax Residency Health Check](https://nomadtaxhelp.com/health-check) takes 2 minutes. For the full process end-to-end: [the complete Paraguay setup guide](/posts/paraguay-tax-residency-guide). Year one of Paraguay residency is, by a comfortable margin, the cheapest year of tax your future self will ever have.
